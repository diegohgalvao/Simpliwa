/*
  ...
  1. Dropping and recreating the handle_new_user function with proper error handling
  2. Creating all necessary helper functions for RLS policies
  3. Ensuring proper permissions and triggers are in place

  ## Changes Made
  - Fixed handle_new_user() function to properly handle company creation
  - Added comprehensive error handling to prevent signup failures
  - Created all missing helper functions for RLS policies
